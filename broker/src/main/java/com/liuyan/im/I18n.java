...
public class I18n {
    ...
    public static String getString(String language, String key) {
        ...
        if (bundle == null) {
            System.out.println(new Locale(language) + "  ====    " + Loader.getParent());
    ...
    public static void test() throws MalformedURLException {
      ...
      /*  // 设置定制的语言国家代码
        ...
        // 获得相应的key值
        String greeting = getString("zh_CN", "Above_Greeting_Message");
        String userInfo = getString("zh_CN", "Friend_Can_Start_Chat");
