...
public class ConnectionDescriptor {
    //TODO:维护单个连接的信息，如ClientID、Channel和clean会话
    ...
    public boolean close() {
        LOG.info("关闭连接描述符。 MqttClientId = {}.", clientID);
    ...
    public boolean assignState(ConnectionState expected, ConnectionState newState) {
        LOG.debug(
                "更新连接描述符的状态。 MqttClientId = {}, expectedState = {}, newState = {}.",
                clientID,
                expected,
                newState);
        ...
        if (!retval) {
            LOG.error(
                    "无法更新连接描述符的状态。 MqttclientId = {}, expectedState = {}, newState = {}.",
                    clientID,
                    expected,
                    newState);
        }
