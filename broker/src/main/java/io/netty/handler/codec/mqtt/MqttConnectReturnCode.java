...
public enum MqttConnectReturnCode {
    ...
    CONNECTION_REFUSED_UNACCEPTABLE_PROTOCOL_VERSION((byte) 0X01), //1
    CONNECTION_REFUSED_IDENTIFIER_REJECTED((byte) 0x02), //2
    CONNECTION_REFUSED_SERVER_UNAVAILABLE((byte) 0x03), //3
