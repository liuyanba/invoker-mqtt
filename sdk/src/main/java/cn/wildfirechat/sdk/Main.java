...
public class Main {
    ...
    static void testUserRelation() throws Exception {
        System.out.println("老刘开始测试=======================================");
        Gson gson = new Gson();
        IMResult<OutputStringList> commonFriendIdList = RelationAdmin.getCommonFriendIdList("26949027797925889");
        OutputStringList result = commonFriendIdList.getResult();
        List<String> list1 = result.getList();


        IMResult<OutputStringList> notAddFriendIdList = RelationAdmin.getUserNotAddFriendIdList("1");
        OutputStringList notAddFriendIdListResult = notAddFriendIdList.getResult();
        List<String> list = notAddFriendIdListResult.getList();

        System.out.println("老刘测试结束=======================================");
    ...
    static void testMessage() throws Exception {
        ...
        IMResult<SendMessageResult> resultSendMessage = MessageAdmin.sendMessage(null);
